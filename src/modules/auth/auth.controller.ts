...
export class AuthController {
  ...
  @Post('register')
  @ApiCreatedResponse({ description: 'User has been successfully registered.', type: User })
  ...
  @Post('login')
  @ApiOkResponse({ description: 'User has been successfully logged in.', type: String }) // Возвращается токен (строка)
  ...
  @Post('profile')
  @ApiBearerAuth()
  @ApiOkResponse({ description: 'User profile has been successfully retrieved.', type: User })
